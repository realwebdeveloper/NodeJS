...
var Main = function (_React$Component) {
    ...
    function Main(props) {
        ...
        _this.saveData = function (variable, data) {
            _this.setState(_defineProperty({}, variable, data));
        };

        _this.getData = function (variable) {

            var saveData = _this.saveData;
    ...
    _createClass(Main, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_hello2.default, { name: user.name, age: user.age }),
